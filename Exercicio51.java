...
public class Exercicio51 {
	...
	static JFrame janela5;
	static JLabel informacao;
	static JLabel capa;
	static JLabel capa2;
	static JLabel capa3;
	static JLabel capa4;
	...
	static String[] tabela1 = new String[] { "Código", "Nome", "Endereço", "E-mail", "Telefone", "Telefone Comercial",
			"Celular", "Telefone Residencial", "Telefone Recado" };
	...
	static void componentes() {
		...
		informacao = new JLabel("Sistema de Cadastro de Cliente, desenvolvimento Flávio Prado S/A");
		informacao.setBounds(80, 240, 750, 20);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (a.equalsIgnoreCase("admin") && b.equalsIgnoreCase("admin")) {
					...
					JOptionPane.showMessageDialog(null, "Seja bem vindo!\n"
							+ "Por favor, visite o campo 'Ajuda', para saber mais sobre o sistema. Obrigado. ");
	...
	static void telaCadastro() {
		...
		ajuda.setSize(110, 20);
		ajuda.setLocation(675, 30);
	...
	static void botoesCadastros() {
		ajuda.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Sistema de Cadastro de Cliente 1.0 versão beta! \n"
						+ "1- Com este sistema, você pode 'Adicionar', 'Editar', 'Exlcluir' e 'Salvar' seus clientes. \n"
						+ "2- Para cadastrar seus clientes, preencha os campos (Os campos com * são obrigatóriso) e clique em Salvar! \n"
						+ "3- Em seguida clique no botão 'Novo', para cadastrar mais clientes.\n"
						+ "4- O limite para cadastrar seus clientes é de '100' pessoas, aproveite, comece a cadastrar agora.");
		...
		salvar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				 ...
				 * salvarRegistro();
				 * 
				 * janela3.dispose(); cod++; telaCadastro();
				 */
				...
				if (campo1.getText().isEmpty() || campo2.getText().isEmpty() || campo3.getText().isEmpty()
						|| telefone.getText().isEmpty() || telefone2.getText().isEmpty()
						|| telefone3.getText().isEmpty() || telefone.getText().isEmpty()) {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (excluir.isEnabled()) {
					if (JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir?", null,
						...
						j = 0;
						i = Integer.parseInt(campo4.getText())-1;
		...
		consultar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				rolagem2.setBounds(10, 10, 1200, 300);
